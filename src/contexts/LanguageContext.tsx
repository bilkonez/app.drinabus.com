...
const translations = {
  sr: {
    ...
    'detailedServices.international.desc': 'Prevoz do Hrvatske, Srbije, Slovenije, Crne Gore, Albanije, Makedonije i drugih balkanskih destinacija. Iskusni vozači i komforni autobusi.',
    ...
    'faq.a1': 'Rezervacije možete izvršiti telefonskim putem na +387 65 550 031, preko WhatsApp-a ili putem email-a na drinavus@gmail.com. Preporučujemo rezervaciju najmanje 7 dana unaprijed za najbolju dostupnost.',
    ...
    'faq.a3': 'Da, svi naši autobusi su moderno opremljeni sa klimatizacijom, udobnim sjedištima i prostorom za prtljag. Veći autobusi također imaju toalet i WiFi.',
    ...
    'faq.a6': 'Da, nudimo prevoz do većine balkanskih i evropskih destinacija uključujući Hrvatsku, Srbiju, Sloveniju, Crnu Goru, Albaniju, Makedoniju i druge zemlje. Imamo iskusne vozače sa svim potrebnim dozvolama.',
  ...
  en: {
    ...
    'detailedServices.international.desc': 'Transport to Croatia, Serbia, Slovenia, Montenegro, Albania, North Macedonia and other Balkan destinations. Experienced drivers and comfortable buses.',
    'detailedServices.airport.title': 'Airport Transfer',
    ...
    'faq.a6': 'Yes, we offer transport to most Balkan and European destinations including Croatia, Serbia, Slovenia, Montenegro, Albania, North Macedonia and other countries. We have experienced drivers with all necessary permits.',
